...
- *Why do Block Types like, .B--container, B--content, B--list, and so exist?  These classes are just added CSS bloat*

The Block types are used for two primary reasons.  One, they prevent css specificity problems.  Two, if you keep all of your Block Types together in your CSS, it helps structuring your .css file.
...
- *Why do you seperate components into Blocks, Skins, and Arrays?*
